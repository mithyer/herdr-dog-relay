...
Status: `checkpointed` for QRM-PROD-1 P4 local cross-platform validation at Relay `074d84d`. QRM-1 Q4/Q5 endpoint evidence and P2/P3 checkpoints remain preserved. P4 validates local same-port enrollment/no-forward and disposable updater/service behavior only; deployment remains unverified and P6 is planned/inactive.
...
[checkpointed](1-135) 2026-08-24 | QRM-PROD-1 P4 local validation checkpointed

...
Status: `active` for QRM-PROD-1 P4 local cross-platform validation. QRM-1 Q4/Q5 security evidence and P2/P3 checkpoints remain preserved. P4 validates local verified enrollment/revocation, independent quota/no-forward boundaries, updater rollback, and disposable user-service behavior; live deployment and P6 lifecycle evidence remain open.
